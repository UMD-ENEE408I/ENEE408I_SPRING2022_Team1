...
const unsigned int M1_IN_1_CHANNEL = 1; //TO MOVE BACKWARDS
const unsigned int M1_IN_2_CHANNEL = 2; //TO MOVE FORWARDS
const unsigned int M2_IN_1_CHANNEL = 3; //TO MOVE BACKWARDS
const unsigned int M2_IN_2_CHANNEL = 4; //TO MOVE FORWARDS
...
const unsigned int PWM_VALUE = 40; // Max PWM given 8 bit resolution
